...
== Setup
* Install the following gems : cucumber, capybara, selenium-webdriver

    sudo gem install cucumber capybara selenium-webdriver
    
* Move config/config.yml.example to config/config.yml and edit as needed. 

    cp config/config.yml.example config/config.yml
    
  Supported browsers include : firefox, chrome.
